...
<GridItem col={5} row={9}>
    <label style={{color: "turquoise", fontWeight: "bold"}}>
         {"From Account"}
    </label>
</GridItem>
...
<GridItem col={27} row={11}>
    <Input maxLength={8} name='faccno' id='faccno' type='number' styles={{color: "green", textDecoration: "underline", fontWeight: "bold"}}  onChange={handleInputChange} onKeyDown={handleSubmit}/>
</GridItem>
...
<GridItem col={37} row={19}>
    <label style={{color: "green", textDecoration: "underline", fontWeight: "bold"}}>
         {receivedData.tscde3 }
    </label>
</GridItem>
...
<GridItem col={27} row={20}>
    <Input maxLength={8} name='taccno' id='taccno' type='number' styles={{color: "green", textDecoration: "underline", fontWeight: "bold"}}  onChange={handleInputChange} onKeyDown={handleSubmit}/>
</GridItem>
